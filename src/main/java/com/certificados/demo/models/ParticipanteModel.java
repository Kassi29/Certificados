...
public class ParticipanteModel extends PersonaModel{
    ...
    public ParticipanteModel(String tipo, int ci, String email,  String materno, String nombre, String parterno) {
        super(ci, email,  materno, nombre, parterno);
        this.tipo = tipo;
    }
    public ParticipanteModel(String tipo, int ci, String email,  String materno, String nombre, String parterno, ArrayList<CertificadoModel> certificados) {
        super(ci, email,  materno, nombre, parterno);
        this.tipo = tipo;
